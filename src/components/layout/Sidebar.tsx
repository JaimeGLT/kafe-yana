...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'fidelizacion-config',         label: 'Configuración de puntos',    icon: null, path: '/fidelizacion/config',                   groupLabel: 'Configuración', allowedRoles: [ADMIN, CAJERO] },
      { id: 'fidelizacion-productos',      label: 'Productos canjeables',        icon: null, path: '/fidelizacion/productos',               allowedRoles: [ADMIN, CAJERO] },
      { id: 'fidelizacion-promos-perm',    label: 'Promociones permanentes',     icon: null, path: '/fidelizacion/promociones-permanentes',  groupLabel: 'Promociones', allowedRoles: [ADMIN, CAJERO] },
      { id: 'fidelizacion-promos-temp',    label: 'Promociones de temporada',    icon: null, path: '/fidelizacion/promociones-temporada',    allowedRoles: [ADMIN, CAJERO] },
      { id: 'fidelizacion-hitos',          label: 'Hitos por compra',            icon: null, path: '/fidelizacion/hitos',                   allowedRoles: [ADMIN, CAJERO] },
      { id: 'fidelizacion-sorteos',        label: 'Sorteos',                     icon: null, path: '/fidelizacion/sorteos',                 allowedRoles: [ADMIN, CAJERO] },
      { id: 'fidelizacion-referidos',      label: 'Referidos',                   icon: null, path: '/fidelizacion/referidos',               allowedRoles: [ADMIN, CAJERO] },
      { id: 'fidelizacion-notifs',         label: 'Notificaciones',              icon: null, path: '/fidelizacion/notificaciones',           allowedRoles: [ADMIN, CAJERO] },
    ],
  },
  {
    id: 'purchases',
