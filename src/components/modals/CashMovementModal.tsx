...
export const CashMovementModal: React.FC<CashMovementModalProps> = ({
  ...
  const hasOpenRegister = currentRegister?.status === 'open';
    ...
    >
      {!hasOpenRegister ? (
        <div className="flex flex-col items-center gap-4 py-8 text-center">
          <div className="flex items-center justify-center h-14 w-14 rounded-full bg-red-50">
            <AlertCircle className="h-7 w-7 text-red-500" />
          </div>
          <div>
            <p className="text-base font-semibold text-coffee-900">No hay caja abierta</p>
