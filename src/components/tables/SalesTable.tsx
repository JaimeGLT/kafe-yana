    ...
    >
      ...
      {isOpen && (
        ...
        >
          {onPrint && (
            <button
              className="w-full flex items-center gap-2 px-3 py-2 text-[13px] text-coffee-800 hover:bg-coffee-50 transition-colors text-left"
          ...
          {showFactura && (
            <button
              className="w-full flex items-center gap-2 px-3 py-2 text-[13px] text-coffee-800 hover:bg-emerald-50 transition-colors text-left border-t border-coffee-100"
              ...
              >
                ...
                <div className="flex gap-1 pt-1 flex-wrap">
                  {onView && (
                    <button
                      onClick={() => onView(sale)}
                      className="flex-1 min-w-[60px] flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-coffee-200 text-coffee-600 hover:bg-coffee-50 text-[12px] font-medium transition-colors"
                    >
                  ...
                  {onPrint && (
                    <button
                      ...
                      className="flex-1 min-w-[80px] flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-coffee-200 text-coffee-600 hover:bg-coffee-50 text-[12px] font-medium transition-colors"
                    >
                  ...
                  {onPrintFacturaSiat && sale.siatAceptada && sale.numeroFactura != null && (
                    <button
                      ...
                      className="flex-1 min-w-[80px] flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-emerald-200 text-emerald-700 hover:bg-emerald-50 text-[12px] font-medium transition-colors"
                    >
                  ...
                  {onRefund && reversible && (
                    <button
                      onClick={() => onRefund(sale)}
                      className="flex-1 min-w-[80px] flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-amber-200 text-amber-600 hover:bg-amber-50 text-[12px] font-medium transition-colors"
                    >
